...
//			access(in);
	...
	public static void loggedInMenu(Scanner in) throws InputMismatchException{
		...
		case 0:
			...
			String key = in.next();
			Account account = news.selectAccountByName(key);
			withdraw(account, in);
			break;
		case 1:
			System.out.println("Which account would you like play around with?");
			String key1 = in.next();
			Account account1 = news.selectAccountByName(key1);
			deposit(account1, in);
			break;
		case 2:
			System.out.println("Which account would you like play around with?");
			String key2 = in.next();
			Account account2 = news.selectAccountByName(key2);
		...
		case 4:
			...
			String key3 = in.next();
			try {
			Account account4 = news.selectAccountByName(key3);
	...
	public static void access() throws InputMismatchException{
