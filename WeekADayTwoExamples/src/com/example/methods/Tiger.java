...
public class Tiger {
	...
	public String toString() {
		String info = "Does tiger have an eye?" + hasEye + "and the name is " + name + "and number of legs is " + numberOfLegs + "and number of stripes is"
				+ stripes;
		return info;
	...
	public void info() {
		System.out.println("Tiger's name is " + name +  ". And it has " + numberOfLegs + "legs");
	}
