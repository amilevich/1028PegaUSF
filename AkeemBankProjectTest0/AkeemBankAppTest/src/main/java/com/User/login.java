...
import com.employeeDuties.EmployeeDuties;
...
public class login {
	...
	private static final AccountHandler AccountHandler = null;
	private static Object accountHandler;
	...
	public static boolean displayAccountOptions(ArrayList<Integer> CustNormalAccNumbers,
		...
		System.out.println("0---please type in 0 to withdraw");
		System.out.println("1---please type in 1 to deposit");
		System.out.println("2----please type in 2 to transfer");
		System.out.println("3----please type in 3 to cancel joint account");
		System.out.println("4----please type in 4 to cancel normal account");
		System.out.println("5----please type in 5 to link account");
		System.out.println("6----please type in 6 to exit");
		int AccNum = 0;
		int ToAccNum = 0;
		int Amount = 0;
