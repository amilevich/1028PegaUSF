...
public class IdentificationDatabase  implements Serializable{
	...
	private static final long serialVersionUID = -2406552655174501016L;
    ...
    public IdentificationDatabase(){
    	this.nextAvailableCustomerBankID = 70000000;
    	this.nextAvailableEmployeeBankID = 80000000;
    	this.nextAvailableAccountNumber  = 90000000;
    }
