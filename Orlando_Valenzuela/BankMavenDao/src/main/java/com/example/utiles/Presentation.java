...
public class Presentation {
	...
	private String[] readCredentiales() {
		    ...
		    boolean credencialControl = true;
		    ...
		    do 
		    {
				...
				if (controller.existUserName(u[0])) {
				
					System.out.println("Please User already exist, choose another: ");	 	 	
				}
				else {
					credencialControl = false;
				}
				
				
				
		    }while (credencialControl);	
	...
	private void registerCustomer() {
		...
		if (oprm == 1) {
			cl.add(new Customer(user1[0], user1[1], 1));
		}
		else {
			cl.add(new Customer(user1[0], user1[1], 1));
			cl.add(new Customer(user2[0], user2[1], 1));
		}
					 ...
					 do {
					   ...
					   if (cl.size() > 0) {
						 ...
						 for(int i = 0; i < cl.size(); i++) {
							 System.out.println(" " + (i+1) + ": User: " + cl.get(i).getUserName() + " Account: " + cl.get(i).getAccount().getAccountNum());		 
						 }
					 ...
					 do {
						    ...
						    if (cl.size() > 0) {
							 ...
							 if (withdraw > 0 && cl.get(nac -1).getAccount().getBalance()> withdraw) {
								 ...
								 controller.deposit(cl.get(nac -1).getAccount().getAccountNum(), withdraw);
					 ...
					 do {
						    ...
						    if (cl.size() > 0) {
							 ...
							 if (deposit > 0) {
								 ...
								 controller.deposit(cl.get(nac -1).getAccount().getAccountNum(), deposit);
								 System.out.println("Your transaction was successful.");							 
					 ...
					 do {
						    ...
						    if (cl.size() > 0) {
							 ...
							 if (transfer > 0 && customer.getAccount().getBalance() > transfer) {
								 ...
								 controller.transferMoney(customer.getAccount().getAccountNum(), cl.get(adc -1).getAccount().getAccountNum() , transfer);
								 System.out.println("Your transaction was successful.");							 
				 ...
				 case 2:{//Withdraw
					 do {	 
						 ...
						 if (withdraw > ((Customer)user).getAccount().getBalance()) {
							 ...
							 controller.withDraw(((Customer)user).getAccount().getAccountNum(), withdraw);
							 ((Customer)user).getAccount().setBalance(((Customer)user).getAccount().getBalance() - withdraw);
							 System.out.println("Your transaction was successful,"
				 ...
				 case 3:{//Deposit
					 ...
					 do {	 
						 ...
						 if (deposit > 0) {
							 ...
							 controller.deposit(((Customer)user).getAccount().getAccountNum(), deposit);
							 
							 ((Customer)user).getAccount().setBalance(((Customer)user).getAccount().getBalance() + deposit);
				 ...
				 case 4:{//Transfer
					 do {	 
							 ...
							 if (controller.existAccount(transferaccount) 
								 ...
								 controller.transferMoney(((Customer)user).getAccount().getAccountNum(), transferaccount, transfer);
								 ((Customer)user).getAccount().setBalance(((Customer)user).getAccount().getBalance() - transfer);
