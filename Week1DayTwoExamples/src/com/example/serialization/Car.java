...
public class Car implements Serializable {
	 ...
	 * Serializable class.
	 * 
	 * It is used during deserialization to verify that the sender and 
	 * the receiver of the serialized object have loaded the correct class
	 * 
	...
	private transient int doors;// transient keyword hides data in the process of deserialization
