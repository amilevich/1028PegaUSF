...
public class Admin{
	...
	public static void viewApplications() { 
		...
		custList = MainDriver.cDAO.selectAllCustomers(); //SQL!!
	...
	public static void viewJApplications() {
		...
		try {
			...
			custCred = MainDriver.cDAO.selectAllCustomers(); //SQL!!
...
public static void approveJointApplication(Customer x) {
		...
		MainDriver.cDAO.updateCustomer(z); //SQL!
...
public static void denyJointApplication(Customer x) {
	...
	public static void money(Customer x) {
		...
		case 3:
			...
			break;
		case 4:
			MainDriver.cDAO.deleteCustomer(x); //SQL
	...
	public static void transferFunds(Customer x) {
		...
		System.out.println(x.getUsername() + "'s Account balance...." 
		+   x.getFunds());
		System.out.println(tempTrans.getUsername() + "'s Account balance...." 
		+   tempTrans.getFunds());
		...
		case 1:
			if (transAmount > tempTrans.getFunds()) {
				...
				MainDriver.cDAO.updateCustomer(tempTrans); //SQL

				System.out.println("New Balance for '" + x.getUsername() + "'...." 
				+   x.getFunds());
				System.out.println("New Balance for '" + tempTrans.getUsername() + "'...." 
				+   tempTrans.getFunds());
		...
		case 2:
			if (transAmount > x.getFunds()) {
				...
				System.out.println("New Balance for '" 
				+ x.getUsername() + "'...." +   x.getFunds());
				System.out.println("New Balance for '"
				+ tempTrans.getUsername() + "'...." +   tempTrans.getFunds());
				Loggy.info("Money transfered by Admin! From: "+ x.getUsername() );
			}
			break;
		case 3:
