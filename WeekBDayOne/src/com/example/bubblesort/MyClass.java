...
public class MyClass {
	 ...
	 * repeatedly performs comparison of adjacent elements and 
	 * swaps them if they are in the wrong order.
	 * 
	 * The basic idea can be described:
	 * 1)Take two adjacent elements
	 * 2)Compare said elements
	 * 3)If the first is greater than the second and we are ordering
	 * from least to greatest -> swap them
	 * If the first is less than the second and we are ordering from
	 * least to greatest -> leave them
	 */
